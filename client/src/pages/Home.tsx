...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20">
      ...
      {showScrollTop && (
        <Button
          className="fixed bottom-24 right-6 z-40 rounded-full w-12 h-12 bg-secondary text-secondary-foreground shadow-lg hover:bg-secondary/90 animate-in fade-in slide-in-from-bottom-5"
          onClick={scrollToTop}
